...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if ($inputId === 911) {
        ...
        if ($inputPassword === '123') {
            $_SESSION['loggedinadmin'] = true;  // Set session variable
            header("Location: admin-dashboard.php");
            exit;
        } else {
        ...
        <section class="text-center">
            <div>
                <h1
                    ...
                    Janta Clinic Dashboard</h1>
            </div>
            <p class="mb-6 text-lg font-normal text-blue-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">Admin
                Login</p>
        </section>
        <section>
