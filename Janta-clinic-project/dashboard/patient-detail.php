...
<body>
    ...
    $patients = $patient_manager->getPatients();
    $id = $_POST['id'];
    // Pagination code
    $limit = 4;
    if (isset($_GET['page'])) {
    ...
    $offset = ($page - 1) * $limit;
    // Running query
    $patientPage =  $patient_manager->getPatientsPagination($offset, $limit);
    ...
    <main>
        <div>
            <h1
                ...
                Registered Patient's</h1>
            <div class="mb-3"> <a type="button" href="../dashboard/patient-register.php"
                    class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Register
                    Patient</a>
        <form class="max-w-lg mb-4 mt-4" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
    <div class="flex">
        <input type="search" id="search-dropdown" name="id"
            ...
            placeholder="Search by Patient firstname or Id..." required />
        <button type="submit"
            ...
            <?php if (isset($_POST['id'])) {
                $patientsSearch = $patient_manager->searchPatients($id);
            ...
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg mb-8">
                <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    ...
                    <?php foreach ($patientsSearch as $patient) : ?>
                    <tbody>
                        <tr
                            ...
                            <td class="px-6 py-4">
                                <a href="../dashboard/patient-manage.php?id=<?php echo htmlspecialchars(
                                                                                            $patient->getPatientId()
            ...
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    ...
                    <?php foreach ($patientPage as $patient) : ?>
                    <tbody>
                        <tr
                            class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                            <th scope="row"
                        ...
                        <!-- <tr
                            ...
                            <td class="px-6 py-4">
                                <a href="../dashboard/patient-manage.php"
                                    class="focus:outline-none text-white bg-yellow-700 hover:bg-yellow-800 focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-sm px-3 py-2 me-2 mb-2 dark:bg-yellow-600 dark:hover:bg-yellow-700 dark:focus:ring-yellow-800">Show</a>
                            </td>
                        </tr> -->
                    </tbody>
        ...
        <ul class="inline-flex -space-x-px text-base h-10 mt-10">
            <?php if ($page > 1) { ?>
            <li>
                <a href="../dashboard/patient-detail.php?page=<?php echo htmlspecialchars($page - 1) ?> ?>"
            ...
            ?>
            <li class="">
                <a href="../dashboard/patient-detail.php?page=<?php echo htmlspecialchars($i); ?>"
