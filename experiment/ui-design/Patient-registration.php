...
<body>
    ...
    <main>
        ...
        <form action="patient-save.php" method="post">
            <div class="grid gap-6 mb-6 md:grid-cols-3">
                ...
                <div>
                    <label for="website" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Blood
                        Group</label>
            ...
            <textarea id="message" rows="4"
                ...
                placeholder="Write your Medical History..."></textarea>
